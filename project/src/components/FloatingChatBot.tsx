...
const FloatingChatBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I'm your ArcticVault assistant. How can I help you today?",
      isBot: true,
      timestamp: new Date()
    }
  ]);
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Dancing Ice Cubes Animation */}
          <div className="relative">
            <MessageCircle size={24} />
            <motion.div 
              className="absolute -top-1 -right-1 w-3 h-3 bg-white rounded-sm"
              animate={{
                rotate: [0, 180, 360],
                scale: [1, 1.2, 1],
              }}
            ...
            />
            <motion.div 
              className="absolute -bottom-1 -left-1 w-2 h-2 bg-cyan-200 rounded-sm"
              animate={{
                y: [0, -5, 0],
                rotate: [0, -180, -360],
              }}
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex space-x-2">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-2 rounded-full hover:shadow-lg transition-all duration-300"
                >
                  <Send size={16} />
                </motion.button>
              </div>
